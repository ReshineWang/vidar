...
SAVE_DIR=./output
# HDF5 Input logic
TEST_VIDEO_PATH=/data/dex/large-video-planner/outputs/latest-run/visualizations/train/epoch_2_step_0/rank_1_sample_0_vid_0.mp4
...
# HDF5_PATH="/data/dex/RoboTwin/data/click_bell/demo_clean_vidar/data/episode0.hdf5"
